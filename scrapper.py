...
# Aiogram setup
BOT_TOKEN = "7011349399:AAGTyOIUypihgDFgvh4YLh-iG06r-KnEypo"   # Replace this BOT_TOKEN
bot = Bot(token=BOT_TOKEN)
dp = Dispatcher(bot)

# Pyrogram setup
api_id = "9538821"   # Replace this API ID with your actual API ID
api_hash = "019e69a6e49805cc2ad95697b30077c7"  # Replace this API ID with your actual API HASH
phone_number = "+917481062991"    # Replace this API ID with your phone number
            ...
            if unique_messages:
                ...
                with open(file_name, 'rb') as f:
                    caption = (
                        ...
                        f"<b>━━━━━━━━━━━━━━━━</b>\n"
                        f"<b>Card-Scrapper By: <a href='https://t.me/zodmadara'>𝚉𝚘𝚍 𝙼𝚊𝚍𝚊𝚛𝚊</a></b>\n"
                    )
